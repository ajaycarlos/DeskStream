...
class ConfigWindow:
    ...
    Allows editing screen edge alignment, friction timing, and connection protocol modes.
    """
    def __init__(self, settings_manager, on_save_callback=None):
        ...
        radio_frame.grid(row=4, column=1, pady=10, sticky=tk.E)
        ...
        # Spacer row
        main_frame.grid_rowconfigure(5, minsize=20)
    ...
    def _on_slider_move(self, value):
        """Updates the slider text label on move."""
        ms = int(float(value))
